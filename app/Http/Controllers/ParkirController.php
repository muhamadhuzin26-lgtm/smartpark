   ...
   public function keluar(Request $request)
{
    ...
    $durasi = max(1, Carbon::parse($parkir->waktu_masuk)
        ->diffInHours($waktu_keluar));
    ...
    if (!$tarif) {
        return "Tarif untuk $jenis belum diatur!";
    }
    ...
    return redirect('/struk/' . $parkir->id);
 ...
 public function struk($id)
{
    ...
    return view('struk', compact('parkir','tarif','durasi','biaya'));
}
